    ...
    <div class="dropdown mb-3">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            ...
            @endforelse
                ...
                <li><a class="dropdown-item" href="{{ route('home',$id) }}">all</a></li>
        </ul>
    </div>
...
<div class="container alert alert-info">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-10 col-md-11">
                                ...
                                <div class="comment-text fs-5">
                                    ...
                                    <a href="{{ route('article_show',['id'=>$id,'artical_id'=>$artical->id]) }}"><button type="button" class="btn btn-info btn-sm w-25">
                                        show
                                    </button></a>
    ...
    @empty
    <div class="alert alert-danger">DONT TO ARTICAL</div>
    @endforelse
</div>
